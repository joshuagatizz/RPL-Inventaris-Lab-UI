...
onMounted(() => {
  const store = useStore();
  store.setPageTitle('LaporanBersama');
})
...
<template>
  ...
  <div class="flex" style="font-family:monospace">
    <Navbar></Navbar>
      ...
      <!-- Content Lihat Laporan Start -->
      <div class="content" id="content-lihatlaporanAdmin">
        <h1 class="title-content"> Lihat Laporan </h1>
        <!-- Card Start -->
        <div class="block justify-center mt-5">
          <div class="card relative mt-5">
            <img src="https://media.discordapp.net/attachments/976696861207433219/990002826400907334/nobita.jpg" class="rounded-full" width="90" height="90">

            <p class="font-Default ml-5">
              <span class="title-card">Nobita</span>
              <br>
              <span class="description-card">13011xxxx</span>
            </p>
            <div class="absolute mr-6 right-0">
              <button @click="$router.push('/pinjamanku-bersama')" id="btn-laporan" class="btn mr-3 text-white bg-[#2436D4]">Pinjaman</button>
              <button @click="$router.push('/sanksi-bersama')" id="btn-sanksi" class="btn text-white bg-[#FF4930]">Sanksi</button>
            </div>
          </div>
          <div class="card relative mt-5">
            <img src="https://media.discordapp.net/attachments/976696861207433219/990002826400907334/nobita.jpg" class="rounded-full" width="90" height="90">

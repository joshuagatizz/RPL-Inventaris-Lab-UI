    ...
    <div class="fixed z-10 inset-0 bg-gray-900 bg-opacity-50 overflow-y-auto h-full w-full">
        <div class="modal-teakun py-16">
            ...
            <div class="absolute mr-6 mt-3 right-0">
                <button @click="store.setModalEditAkun(false)" class="btn text-black bg-buttongrey hover:bg-slate-200 mx-4">Batal</button>
                <button @click="editAkun" class="btn text-white bg-buttonsky hover:bg-blue-500">Simpan</button>
            </div>
        </div>
    </div>
</template>